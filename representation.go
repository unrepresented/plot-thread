...
type Representation struct {//TODO: Beware of reordering struct fields, IDs seem to be sensitive to field order.
...
func NewRepresentation(by, forr ed25519.PublicKey, matures, expires, height int64, memo string) *Representation {
	return &Representation{
		...
		Matures: matures,
		Expires: expires,
		Series:  computeRepresentationSeries(by == nil, height),
	}
}
...
// used to recognise the scriber for scribing the plot.
